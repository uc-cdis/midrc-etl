...
s3.meta.client.download_file('external-data-midrc-replication', 'replicated-data-acr/ACR_20211115/clinical_manifestfile_ACR_20211115.tsv', '/midrc-etl/v3/clinical_manifestfile_ACR_20211115.tsv')
